...
organ_name = snakemake.params.get("organ_name", "heart")
...
for pair_list in [sorted_top_pairs_tuple_all, combined_pairs, cell_enr_pairs]:
    ...
    for h5ad_path in deconv_h5ads:
        ...
        plot, _ = li.ut.query_bandwidth(coordinates=adata_sub_extended.obsm['spatial'], start=0, end=600, interval_n=20)
